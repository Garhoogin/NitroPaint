...
#define FILTER_EXTS_TEXTURE        L"*.tga;*.pic;*.5tx;*.tds;*.nnstga"
#define FILTER_EXTS_FONT           L"*.nftr*;*.rtfn;*.bnfr"
#define FILTER_EXTS_CMAP           L"*.bncmp"
#define FILTER_EXTS_IMAGE          L"*.png;*.bmp;*.gif;*.jpg;*.jpeg;*.tga;*.pic"
#define FILTER_EXTS_ALL            L"*.nclr*;*.rlcn;*.ncl;*.icl;*.acl;*.5pl;*.5pc;*.ntfp;*.nbfp;*.bin;*.pltt;*.ncgr*;*.rgcn;*.ncbr;*.ncg;*.icg;*.acg;*.nbfc;*.char;*.nscr*;*.rcsn;*.nsc;*.isc;*.asc;*.nbfs;*.ncer*;*.recn;*.nanr*;*.rnan;*.dat;*.nsbmd*;*.nsbtx*;*.bmd;*.bnr;*.tga;*.pic;*.5tx;*.tds;*.nftr*;*.rtfn;*.bnfr"
